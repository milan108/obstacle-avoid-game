...
public class LoadingScreen extends ScreenAdapter{
    ...
    private boolean changeScreen; // false by default
    ...
    @Override
    public void hide() {
        // NOTE screens arent disposed automatically
        dispose();
    }
    ...
    private void update(float delta){
        ...
        if(assetManager.update()){ //update returns true when all assets are loaded.
            waitTime -= delta;
            if(waitTime <= 0){
                changeScreen = true;
            }
